...
public class Tamil_frag extends Fragment {
    @Nullable
    TextView textView;
    TextToSpeech textToSpeech;
    Button button;
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup viewGroup= (ViewGroup) inflater.inflate(R.layout.tamil_frag,container,false);
        textView = viewGroup.findViewById(R.id.text_tamil);
        button = viewGroup.findViewById(R.id.speaker_tamil);
        Translate_frag activity = (Translate_frag) getActivity();
        assert activity != null;
        String text = activity.getText();
        String URL_l = "https://api.mymemory.translated.net/get?q="+text+"&langpair=en|ta";
